...
#w_ob1 = w_ob                           # Obstacle weight
#w_ob2 = w_ob                           # Obstacle weight
#w_ob3 = w_ob                           # Obstacle weight
...
perc_log_rollout_interval = 1/200
log_rollout_interval = int((NEPISODES-ep_no_update)/perc_log_rollout_interval)
perc_log_interval = 1/20
log_interval = int((NEPISODES-ep_no_update)/perc_log_interval)
