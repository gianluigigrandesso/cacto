...
class TO_Pyomo(CACTO):
    def __init__(self, env, NORMALIZE_INPUTS, EPISODE_CRITIC_PRETRAINING, tau_upper_bound, 
        ...
        super(TO_Pyomo, self).__init__(env, NORMALIZE_INPUTS, EPISODE_CRITIC_PRETRAINING, tau_upper_bound, 
                 tau_lower_bound, dt, system_param, TO_method, system, nsteps_TD_N, soft_max_param, obs_param, weight, 
                 target, NSTEPS, EPISODE_ICS_INIT, TD_N, prioritized_replay_eps,prioritized_replay_alpha,
                state_norm_arr,UPDATE_LOOPS, UPDATE_RATE, LR_SCHEDULE, update_step_counter, 
                 NH1, NH2, wreg_l1_A, wreg_l2_A, wreg_l1_C, wreg_l2_C, boundaries_schedule_LR_C,
        ...
        self.target = target
        self.NSTEPS = NSTEPS
        self.EPISODE_ICS_INIT = EPISODE_ICS_INIT
    ...
    m.q2[k])*m.v0[k]**2 + 4*conf.l**2*conf.M*sin(m.q2[k])*m.v0[k]*m.v1[k] + 2*conf.l**2*conf.M*sin(m.q2[k])*m.v1[k]**2) == 0 if k < N else Constraint.Skip)
        ...
        m.ell1_penalty = sum((log(exp(alpha*-((((-7 + conf.l*(cos(m.q0[k]) + cos(m.q0[k]+m.q1[k]) + cos(m.q0[k]+m.q1[k]+m.q2[k])))-XC1)**2)/((A1/2)**2) + (((conf.l*(sin(m.q0[k]) + sin(m.q0[k]+m.q1[k]) + sin(m.q0[k]+m.q1[k]+m.q2[k])))-YC1)**2)/((B1/2)**2) - 1.0)) + 1)/alpha)  for k in m.k) - (log(exp(alpha*-(((-7 + conf.l*(cos(m.q0[0]) + cos(m.q0[0]+m.q1[0]) + cos(m.q0[0]+m.q1[0]+m.q2[0]))-XC1)**2)/((A1/2)**2) + ((conf.l*(sin(m.q0[0]) + sin(m.q0[0]+m.q1[0]) + sin(m.q0[0]+m.q1[0]+m.q2[0]))-YC1)**2)/((B1/2)**2) - 1.0)) + 1)/alpha)
        m.ell2_penalty = sum((log(exp(alpha*-((((-7 + conf.l*(cos(m.q0[k]) + cos(m.q0[k]+m.q1[k]) + cos(m.q0[k]+m.q1[k]+m.q2[k])))-XC2)**2)/((A2/2)**2) + (((conf.l*(sin(m.q0[k]) + sin(m.q0[k]+m.q1[k]) + sin(m.q0[k]+m.q1[k]+m.q2[k])))-YC2)**2)/((B2/2)**2) - 1.0)) + 1)/alpha)  for k in m.k) - (log(exp(alpha*-(((-7 + conf.l*(cos(m.q0[0]) + cos(m.q0[0]+m.q1[0]) + cos(m.q0[0]+m.q1[0]+m.q2[0]))-XC2)**2)/((A2/2)**2) + ((conf.l*(sin(m.q0[0]) + sin(m.q0[0]+m.q1[0]) + sin(m.q0[0]+m.q1[0]+m.q2[0]))-YC2)**2)/((B2/2)**2) - 1.0)) + 1)/alpha)
        m.ell3_penalty = sum((log(exp(alpha*-((((-7 + conf.l*(cos(m.q0[k]) + cos(m.q0[k]+m.q1[k]) + cos(m.q0[k]+m.q1[k]+m.q2[k])))-XC3)**2)/((A3/2)**2) + (((conf.l*(sin(m.q0[k]) + sin(m.q0[k]+m.q1[k]) + sin(m.q0[k]+m.q1[k]+m.q2[k])))-YC3)**2)/((B3/2)**2) - 1.0)) + 1)/alpha)  for k in m.k) - (log(exp(alpha*-(((-7 + conf.l*(cos(m.q0[0]) + cos(m.q0[0]+m.q1[0]) + cos(m.q0[0]+m.q1[0]+m.q2[0]))-XC3)**2)/((A3/2)**2) + ((conf.l*(sin(m.q0[0]) + sin(m.q0[0]+m.q1[0]) + sin(m.q0[0]+m.q1[0]+m.q2[0]))-YC3)**2)/((B3/2)**2) - 1.0)) + 1)/alpha)
        ...
        m.dist_cost = sum((w_d*(((-7 + conf.l*(cos(m.q0[k]) + cos(m.q0[k]+m.q1[k]) + cos(m.q0[k]+m.q1[k]+m.q2[k])))-x_des)**2 + ((conf.l*(sin(m.q0[k]) + sin(m.q0[k]+m.q1[k]) + sin(m.q0[k]+m.q1[k]+m.q2[k])))-y_des)**2) - w_peak*(log(exp(alpha2*-(sqrt(((-7 + conf.l*(cos(m.q0[k]) + cos(m.q0[k]+m.q1[k]) + cos(m.q0[k]+m.q1[k]+m.q2[k])))-x_des)**2 +0.1) - 0.1 + sqrt(((conf.l*(sin(m.q0[k]) + sin(m.q0[k]+m.q1[k]) + sin(m.q0[k]+m.q1[k]+m.q2[k])))-y_des)**2 +0.1) - 0.1 -2*sqrt(0.1))) + 1)/alpha2)) for k in m.k) - (w_d*((-7 + conf.l*(cos(m.q0[0]) + cos(m.q0[0]+m.q1[0]) + cos(m.q0[0]+m.q1[0]+m.q2[0]))-x_des)**2 + (conf.l*(sin(m.q0[0]) + sin(m.q0[0]+m.q1[0]) + sin(m.q0[0]+m.q1[0]+m.q2[0]))-y_des)**2) - w_peak*(log(exp(alpha2*-(sqrt((-7 + conf.l*(cos(m.q0[0]) + cos(m.q0[0]+m.q1[0]) + cos(m.q0[0]+m.q1[0]+m.q2[0]))-x_des)**2 +0.1) - 0.1 + sqrt((conf.l*(sin(m.q0[0]) + sin(m.q0[0]+m.q1[0]) + sin(m.q0[0]+m.q1[0]+m.q2[0]))-y_des)**2 +0.1) - 0.1 -2*sqrt(0.1))) + 1)/alpha2))
    ...
    def TO_Manipulator_Model2(self,ICS, init_q0, init_q1, init_q2, init_v0, init_v1, init_v2, init_a0, init_a1, init_a2, init_tau0, init_tau1, init_tau2, N, init_TO=None):
        m = ConcreteModel()
        m.k = RangeSet(0, N)
    ...
    def TO_Manipulator_Solve(self, ep, env):
        ...
        while TO==0:
            ...
            prev_state = np.array([random.uniform(-math.pi,math.pi), random.uniform(-math.pi,math.pi), random.uniform(-math.pi,math.pi), 
                        ...
                        self.dt*round(rand_time/self.dt)]) #env.reset
            ...
            CACTO.tau0_arr, CACTO.tau1_arr, CACTO.tau2_arr = [],[],[]
            CACTO.q0_arr, CACTO.q1_arr, CACTO.q2_arr = [prev_state[0]], [prev_state[1]], [prev_state[2]]
            CACTO.v0_arr, CACTO.v1_arr, CACTO.v2_arr = [prev_state[3]], [prev_state[4]], [prev_state[5]]
            CACTO.t_arr = [prev_state[-1]]
            CACTO.x_ee_arr = [conf.x_base + conf.l*(math.cos(prev_state[0]) + math.cos(prev_state[0]+prev_state[1]) + math.cos(prev_state[0]+prev_state[1]+prev_state[2]))]
            CACTO.y_ee_arr = [conf.y_base + conf.l*(math.sin(prev_state[0]) + math.sin(prev_state[0]+prev_state[1]) + math.sin(prev_state[0]+prev_state[1]+prev_state[2]))]
            ...
            #print('init c: ', init_TO_controls[:,0])
            ...
            for i in range(1, CACTO.NSTEPS_SH+1):                                                                                                                                    
                init_next_state =  env.simulate(init_prev_state,np.array([init_TO_controls[0][i-1],init_TO_controls[1][i-1],init_TO_controls[2][i-1]]))
            ...
            if ep < self.EPISODE_CRITIC_PRETRAINING or ep < self.EPISODE_ICS_INIT:
                TO_mdl = self.TO_Manipulator_Model(prev_state, init_q0_ICS, init_q1_ICS, init_q2_ICS, init_v0_ICS, init_v1_ICS, init_v2_ICS, init_0, init_0, init_0, init_0, init_0, init_0, CACTO.NSTEPS_SH)
            else:
        ...
        return rand_time, prev_state, tau0_TO, tau1_TO, tau2_TO                      

class TO_Casadi(CACTO):
    def __init__(self, env, NORMALIZE_INPUTS, EPISODE_CRITIC_PRETRAINING, tau_upper_bound, 
                 tau_lower_bound, dt, system_param, TO_method, system, soft_max_param, obs_param, weight, 
                 target, NSTEPS, EPISODE_ICS_INIT, TD_N, prioritized_replay_eps,prioritized_replay_alpha,
                state_norm_arr, UPDATE_LOOPS, UPDATE_RATE, LR_SCHEDULE, update_step_counter, 
                 NH1, NH2, wreg_l1_A, wreg_l2_A, wreg_l1_C, wreg_l2_C, boundaries_schedule_LR_C,
                 values_schedule_LR_C, boundaries_schedule_LR_A, values_schedule_LR_A, 
