    ...
    def TO_Manipulator_Solve(self, ep, env):
        ...
        while TO==0:
            ...
            prev_state = np.array([random.uniform(-math.pi,math.pi), random.uniform(-math.pi,math.pi), random.uniform(-math.pi,math.pi), 
                        ...
                        self.dt*round(rand_time/self.dt)]) # sys_dep #
            ...
            try:
                ...
                if str(results.solver.termination_condition) == "optimal":    
                    ...
                    tau0_TO = [TO_mdl.tau0[k]() for k in K] # sys_dep #
                    tau1_TO = [TO_mdl.tau1[k]() for k in K] # sys_dep #
                    tau2_TO = [TO_mdl.tau2[k]() for k in K] # sys_dep #
